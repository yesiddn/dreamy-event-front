...
export default async function Footer() {
  ...
  paragraph.innerHTML =
    'Somos una empresa dedicada a la organización de eventos,<br> con más de 10 años de experiencia en el mercado. ';
  ...
  ['facebook', 'instagram', 'whatsapp', 'tiktok', 'twitter'].forEach(function (
    network
  ) {
    var a = document.createElement('a');
    a.href = '#';
  ...
  copyright.innerHTML =
    '&copy; Copyright <strong><span>Dreamy event</span></strong>. Casi todos los derechos reservados.';
